...
public class MonteCarloSearchTree implements MonteCarloAI
{
    ...
    private final Set<MonteCarloSearchTreeNode> nodes = Collections
            .newSetFromMap(new ConcurrentHashMap<MonteCarloSearchTreeNode, Boolean>());
    ...
    public ConnectFourMove determineMove(ConnectFourGame game)
    {
        ...
        // "Good enough" barrier, our tree's thread safe, and we don't reallllly
        // care if all of our threads are done or not
